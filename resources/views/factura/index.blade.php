    ...
    <div class="card">
        <div class="car-header py-3">
            <div class="row">
                ...
                <div class="col-md-1">
                    <a href="{{ route('facturas.create') }}" class="btn btn-primary"><i class="bi bi-plus-circle"></i></a>
                </div>
            </div>
        </div>

        <div class="card-body">
            <form action="{{route('factura.index')}}" class="navbar-search" method="GET">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <form action="{{ route('facturas.delete', $factura->id) }}" style="display:contents"
                                method="POST">
                                @csrf
                                @method('DELETE')
            ...
            {{ $facturas->appends(request()->except('page'))->links('components.customPagination') }}
        </div>
